...
// Forward declare pipe names to reduce name mangling (maybe get rid of; pipes
// already have bad names)
class IDPipeA;
class IDPipeB;
class IDPipeC;
...
// this csr pipe will only be read and write once with the total sum
using OutputPipeC =
